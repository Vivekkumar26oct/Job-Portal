            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="flex space-x-4 mt-4 md:mt-0">
                        <a href="https://www.facebook.com/share/1Cun4krKHH/" className="hover:text-gray-400" aria-label="Facebook">
                        ...
                        <a href="https://x.com/vivekkumar26oct?t=pMjkZk1Q654OUfAOCRHVDQ&s=09" className="hover:text-gray-400" aria-label="Twitter">
                        ...
                        <a href="https://www.linkedin.com/in/vivek-kumar-5b7974257/" className="hover:text-gray-400" aria-label="LinkedIn">
                ...
                <div className='text-center mb-0'>
                    <p className="text-sm">© 2025 JobHunt. Made with Love ❤️ by vivek.</p>
                </div>
            </div>
        </footer>
    );
